 <!DOCTYPE html>
  <html>
    <head>
      ...
      <!-- Import Custom CSS -->
      <link type="text/css" rel="stylesheet" href="./assests/css/style.css" media="screen,projection">
      <!-- Import Profile CSS -->
      <link type="text/css" rel="stylesheet" href="./assests/css/profile.css" media="screen,projection">
    ...
    <body>
      <div class="navbar-fixed">
        <nav>
          <div class="nav-wrapper bg-color_main">
            <a href="#!" class="brand-logo center">IEEE Career Fair '17</a>
            <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
              <li><a href="">View Companies</a></li>
              <ul class="right">
               <li><a class="dropdown-button grey-text text-darken-1" href="#!" data-constrainwidth="false" data-beloworigin="true" data-activates="profileopt"> <img class="responsive-img circle" src="./assests/images/user.png" style="height: 36px; position: relative; top: 14px"></a></li>
              </ul>
            </ul>
        ...
        <div>
          <main>
            <div class="jumbo" style="background: url('./assests/images/profile-background.jpg') center top;"></div>
            <div class="container icons">
              <div class="big-icon" style="background-image: url('./assests/images/user.png');"></div>
            </div>
            <div class="details" style="text-align: center;">
              <h3><text class="Fname">Kavinda </text><text class="Mname">Niroshana </text><text class="Lname">Jayakody</text></h3>
              <p class="personal-title">Undergraduate at University of Colombo School of Computing</p>
              <p><text class="email">kavindajayakody@ieee.org </text></br><text class="contact_nu">071 214 2329</text></br>
              <text class="linkedin">LinkedIn : <a href="https://linkedin.com/in/kavinda-jayakody" target="_blank">linkedin.com/in/kavinda-jayakody</a></text></br><text class="github">Github : <a href="https://github.com/kavinda1995" target="_blank">github.com/kavinda1995</a></text></p>
            </div>
            <div class="container">
              <ul class="collapsible" data-collapsible="expandable">
                <li>
                  <div class="collapsible-header active" style="background-color: #607D8B"><i class="material-icons">assignment_ind</i>About Me</div>
                ...
                <li>
                  <div class="collapsible-header active"><i class="material-icons">filter_drama</i>About Me</div>
                  <div class="collapsible-body">
                    <div class="title">
                      <h6>About Me</h6>
                    </div>
        ...
        <footer class="page-footer bg-color_main" style="">
          <div class="container">
            <div class="row">
